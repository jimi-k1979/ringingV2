...
//require_once __DIR__ . '/../../public/classes/apiHandler/ApiHandler.php';
//require_once __DIR__ . '/../../public/classes/class.model.php';
//foreach (glob(__DIR__ . '/../../public/classes/*.php') as $file) {
//    require_once $file;
//}
